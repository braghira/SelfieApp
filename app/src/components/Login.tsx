  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        <img src='public\assets\images\logo.png' alt='logo' className='w-12 h-12 rounded-full'/>
        ...
        <Button type="submit" className="shad-button_primary flex flex-col gap-5 w-full mt-4"> continue without login</Button>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
          ...
          />
          <Button type="submit" className="shad-button_primary flex flex-col gap-5 w-full mt-4">
            {isLoading ? <Loader /> : "Login"}
          </Button>
          <Link to="/forgot-password" className="text-small-regular text-light-2 text-link hover:underline cursor-pointer">Forgot Password?</Link>
